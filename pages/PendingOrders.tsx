...
export default function PendingOrders() {
  ...
  const pendingOrders = useMemo<Order[]>(() => {
    // Feature desativada conforme solicitação: "sem os pedidos aparecerem nela"
    return [];
  }, []);
              ...
              <div className="bg-[#121215] border border-zinc-800 w-full max-w-2xl max-h-[85vh] rounded-3xl flex flex-col shadow-2xl overflow-hidden">
                  ...
                  <div className="flex-1 overflow-y-auto p-6 space-y-8 custom-scrollbar">
                      <div className="bg-zinc-900/50 border border-zinc-800 rounded-2xl p-6">
                          <h3 className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest mb-4 ml-1">Detalhes do Pedido</h3>
                      </div>
